          ...
          <div class="listing listing-1">
            <div class="listing-ver-1">
              <div class="listing-heading">
                <h5><a href="single_business.html"><center>Login</center></a></h5>
              </div>
              <div class="tab-content">
                <div id="basic" class="tab-pane fade in active basic">
                  <div class="listing-inner" style="padding: 20px;">
<form class="newsletter-form" action="login.php" method="post">
                    <input placeholder="Enter your username" type="text" name="username" value="<?php echo $submitted_username; ?>"/>
